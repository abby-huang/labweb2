...
//定義變數
int pageRows = 100;
String tblname = "labdyn_labinout";
String trans_date = "trans_date1";
String errMsg = "";
Connection con = null;
...
if (srch.length() > 0) {
    ...
    //寫入日誌檔
    String srchdata = "外勞最新出境資料（.ody檔 - labinout）";
...
%>
    ...
    <form action ="<%=thisPage%>" method="post" onsubmit="return confirm('確定要清除傳輸日期欄位嗎？');">
        ...
        <table border=1 bgcolor="#F8BE67" bordercolor="#FF9900" width="340">
            <tr bgcolor="#FF9900">
