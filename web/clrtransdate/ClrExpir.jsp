...
String qexpirwkno = AbString.rtrimCheck(request.getParameter("qexpirwkno")).toUpperCase();
            ...
            <form action ="<%=thisPage%>" method="post">
                ...
                <table border=1 bgcolor="#F8BE67" bordercolor="#FF9900" width="500">
                    ...
                    <tr >
                        ...
                        <td width=25% colspan="3"><input type="text" name="qexpirwkno" value="<%=qexpirwkno%>" size="12"></td>
                    </tr>
                    <tr >
...
if (qexpirwkno.length() > 0) srch += " and expirwkno = " + AbSql.getEqualStr(qexpirwkno);
...
%>
    ...
    <form action ="<%=thisPage%>" method="post" onsubmit="return confirm('確定要清除傳輸日期欄位嗎？');">
        <input type="hidden" name="qexpirwkno" value="<%=qexpirwkno%>">
        ...
        <table border=1 bgcolor="#F8BE67" bordercolor="#FF9900" width="548">
            ...
            <tr bgcolor="#FF9900">
                ...
                <td width=100 align="center">撤銷文號</td>
...
<%
    ...
    while (rs.next()) {
        ...
        String expirwkno = AbString.rtrimCheck(rs.getString("expirwkno"));
...
%>
            ...
            <tr>
                ...
                <td align="center"><%=strCheckNullHtml(expirwkno)%></td>
