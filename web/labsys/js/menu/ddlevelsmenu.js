...
//取得 js file 路徑 2014-12-09
var imgpath = document.getElementById("menuScript");
imgpath = imgpath.src.split("/");
imgpath.pop();
...
arrowpointers:{
	downarrow: [imgpath + "/arrow-down.gif", 11,7], //[path_to_down_arrow, arrowwidth, arrowheight]
	rightarrow: [imgpath + "/arrow-right.gif", 12,12], //[path_to_right_arrow, arrowwidth, arrowheight]
