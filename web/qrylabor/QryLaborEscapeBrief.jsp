...
qs = " select count(distinct f.natcode || f.passno) from labdyn_resident f " + search;
...
<table border=0 width=600>
    ...
    <form action="QryLaborEscapePrint.jsp" target="_blank">
    <td align=left width=5%>
    ...
    <form action="../servlet/QryLaborEscapeText">
    <td align=left width=5%>
