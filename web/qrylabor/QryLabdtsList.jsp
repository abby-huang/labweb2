...
//計算筆數
String qs = "select count(*) from cognos_labdts l " + QryLabdtsSql;
...
<table border=0 width=600>
    ...
    <form action="QryLabdtsListPrint.jsp" target="_blank">
    <td align=left width=5%>
    ...
    <form action="QryLabdtsListCsv.jsp">
    <td align=left width=5%>
...
<table border = 1 bgcolor=#F8BE67 bordercolor=#FF9900 width=1000 style="table-layout: atuo;">
<tr>
