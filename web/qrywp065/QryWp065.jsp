...
<table width="600" border="0" cellspacing="0" cellpadding="0" >
  <tr>
    <td align=center><img src="../image/qry_wp065.gif" alt="藍領外國人主動離境備查案查詢" >
    </td>
  </tr>
  <tr>
    <td align=center><img src="../image/line_main.gif" alt="美化圖形" >
      ...
      <form action="QryWp065Detail.jsp" method="post" onsubmit="return checkPassno(this);">
...
<%}%>
          ...
          <tr bgcolor="#F8BE67">
            ...
            <td >
              <input type=text name=passno></td>
          </tr>
