...
<form action="QryVendMain.jsp" method="post" onsubmit="return checkName(this);">
...
<form action="QryVendWpgnamdBrief.jsp" method="post" onsubmit="return checkWpgnamd(this);">
